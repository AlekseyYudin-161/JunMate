...
def render_upload_screen() -> None:
    ...
    st.success("""
    **Как это работает:**
    1. Загружайте резюме в PDF или описывайте опыт текстом
    2. Общайтесь с ассистентом и улучшайте резюме
    3. Скачивайте готовое резюме или дорабатывайте неточности
    """)
