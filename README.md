...
## Демо
📹 [Видео-демонстрация youtube](https://youtu.be/pVZP7HY1sqM) — полный процесс работы.
...
LLM — через Kodikrouter (OpenAI-совместимый), `gpt-4.1-mini` как основная модель, fallback на Proxyapi и бесплатные модели OpenRouter. 
...
Замеренные прогоны:
- короткое текстовое резюме, 6 основных вопросов + 3 добора (итого 15 ходов): 2.5 ₽
- трёхстраничное PDF-резюме, 6 основных вопросов без доборов: 2.45 ₽
- двухстраничное PDF-резюме, 6 основных вопросов + 1 добор: 2.2 ₽
...
- Добавление форматов сохранения резюме (.docx, .md)
...
- Загрузка и корректировка **мотивационного письма** под обновлённое резюме (с экспортом в .pdf, .docx, .md).
