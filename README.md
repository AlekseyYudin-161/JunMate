...
Замеренные прогоны:
- короткое текстовое резюме, 6 основных вопросов + 3 добора (итого 15 ходов): 7.1 ₽
- трёхстраничное PDF-резюме, 6 основных вопросов без доборов: 5.5 ₽
- двухстраничное PDF-резюме, 6 основных вопросов + 2 добора: 12.2 ₽
