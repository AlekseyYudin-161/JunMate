...
junmate/
  ...
  tests/
  .kodikrules .env.example requirements.txt README.md
```
...
«Опыт» (буллеты с глаголами), «Проекты», «Образование». Деловой тон, по-русски, специфические IT термины - на английском. 
